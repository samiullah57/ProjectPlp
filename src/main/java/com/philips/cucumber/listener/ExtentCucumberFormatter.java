package com.philips.cucumber.listener;
...
public class ExtentCucumberFormatter implements Reporter, Formatter {
    ...
    private static void setExtentHtmlReport(File file) {
        ...
        htmlReporter.config().setDocumentTitle("Philips Salesforce Report");
		htmlReporter.config().setReportName("Philips Automation Test Report");
    }
